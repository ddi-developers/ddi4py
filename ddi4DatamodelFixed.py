...
# The 'type' field in the root of objects specified in the jsonSchema.json file
# (e.g. "$type": "PhysicalInstance") was not being added to the data model 
# generated by pydantic. The below class that extends the BaseModel class is a 
